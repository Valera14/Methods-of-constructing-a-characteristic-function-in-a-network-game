...
for third_player_counter in range(0, len(third_player_strategies)):
    first_index = int(first_strategy_list[0])
    second_index = int(first_strategy_list[1])
    w = int(K_function_2[first_index][second_index][int(third_player_counter)])
...
for forth_player_counter in range(0, len(forth_player_strategies)):
    second_index = int(first_strategy_list[1])
    third_index = int(first_strategy_list[2])
    w = int(K_function_3[second_index][third_index][int(forth_player_counter)])
...
for fifth_player_counter in range(0, len(fifth_player_strategies)):
    ...
    w = int(K_function_4[third_index][forth_index][int(fifth_player_counter)])
...
for sixth_player_counter in range(0, len(sixth_player_strategies)):
    forth_index = int(first_strategy_list[3])
    fifth_index = int(first_strategy_list[4])
    w = int(K_function_5[forth_index][fifth_index][int(sixth_player_counter)])
